...
<div class="container-fluid">
    <div class="row border-top px-xl-5">
        <div class="col-lg-3 col-md-12">
            ...
            <nav class="collapse navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 1;">
