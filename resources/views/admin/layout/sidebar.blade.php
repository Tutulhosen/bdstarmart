...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  <div class="app-brand demo">
    <a href="{{route('admin.dashboard.index')}}" class="app-brand-link" style="margin:30px">
      @if (!empty($logo))
        @if ($logo->image)
        <a href="{{route('admin.dashboard.index')}}"><img src="{{asset('images/logo/' . $logo->image)}}" alt="" style="width: 80px; "></a>
        @else
