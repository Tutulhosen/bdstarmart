            ...
            <div class="card">
                  ...
                  <table class="table text-center">
                    ...
                    <tbody class="table-border-bottom-0">
                            @foreach ($slider_list as $item)
                                <tr>
                                    <td>{{$loop->index+1}}</td>
                                    <td><img style="height: 50px;width:50px; object-fit:cover"  src="{{asset('images/slider/'.$item->image_name)}}" alt=""></td>
                                    <td>
                                        @if ($item->status==1)
                                    ...
                                    <td>
                                        <div class="dropdown">
                                          ...
                                          <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('admin.slider.update.page', $item->id) }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                            <a class="dropdown-item" href="javascript:void(0);" id="slider_dlt_btn" data-id="{{$item->id}}"><i class="bx bx-trash me-1"></i> Delete</a>
                                          </div>
                                        </div>
                                      </td>
                                </tr>
                ...
                <div class="row mt-md-4 mt-2 pagination" style="width: 100%; margin:auto">
                    ...
                    <div class="col-4" >
                        ...
                        {!! $slider_list->links('pagination::bootstrap-4') !!}
                    </div>
                </div>  
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '#active_btn', function(){
            ...
            Swal.fire({
                title: "<div style='color: black;'>Are you sure to InActive this Slider?</div>",
                icon: "warning",
                showCancelButton: true,
                confirmButtonColor: "#3085d6",
                cancelButtonColor: "#d33",
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.status==true) {
                                Swal.fire({
                                    title: "<div style='color: black;'>Successfully InActive The Slider</div>",
                                    icon: "success"
                                });
                                $(".table").load(" .table");
                            }
        ...
        $(document).on('click', '#deactivate_btn', function(){
            Swal.fire({
                title: "<div style='color: black;'>Are you sure to Active this Slider?</div>",
                icon: "warning",
                showCancelButton: true,
                confirmButtonColor: "#3085d6",
                cancelButtonColor: "#d33",
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.status==true) {
                                Swal.fire({
                                    title: "<div style='color: black;'>Successfully Active The Slider</div>",
                                    icon: "success"
                                });
                                $(".table").load(" .table");
                            }
