...
<div class="container pt-5">
    <div class="row">
        <div class="col-1"></div>
        <div class="col-10">
            <a class="btn btn-primary" href="{{route('admin.delivery.charge.create')}}">Add New</a>
            <div class="card">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                          ...
                                          <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('admin.delivery.charge.update.page', $item->id) }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
